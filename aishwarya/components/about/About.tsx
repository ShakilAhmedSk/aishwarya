      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            and personal space come together. Whether you&apos;re staying short-term 
            or long-term, our spaces are designed to feel like home.
          </p>

          <p className="text-gray-600 leading-relaxed">
            With clean environments, essential amenities, and reliable management, 
            Aishwarya Residences ensures a smooth, hassle-free lifestyle for every resident.
          </p>
