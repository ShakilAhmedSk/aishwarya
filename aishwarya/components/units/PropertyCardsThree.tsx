...
export default function PropertyCardsThree() {
  return (
          ...
          {properties.map((item) => (
            ...
            >
              ...
              <div className="relative h-[160px] sm:h-[180px] md:h-[200px] w-full">
                ...
                <span className="absolute top-3 right-3 bg-[#c8020e] text-white 
                text-[10px] sm:text-xs px-3 sm:px-4 py-1 rounded-full font-medium">
                  Available now
                </span>
              </div>
